...
public class AppTest 
{
	...
	private static MapDriver<LongWritable, Text, Text, Text> Q3MapDrive;
	private static MapDriver<LongWritable, Text, Text, Text> Q4MapDrive;
	...
	private static ReduceDriver<Text, Text, Text, FloatWritable> Q3ReduceDrive;
	private static ReduceDriver<Text, Text, Text, FloatWritable> Q4ReduceDrive;
	...
	private static MapReduceDriver<LongWritable, Text, Text, Text, Text, FloatWritable> Q3mapReduceDriver;
	private static MapReduceDriver<LongWritable, Text, Text, Text, Text, FloatWritable> Q4mapReduceDriver;
	...
	{	
		...
		Q1MapDrive.withOutput(new Text("test"), new FloatWritable(13.37F));
	...
	public void TestQ1MapReduceRow()
	{
		...
		Q1mapReduceDriver.withOutput(new Text("test"), new FloatWritable(13.37F));
	...
	public void TestQ2MapperExampleRow()
	{
		...
		Q2MapDrive.withOutput(new Text("United States"), new FloatWritable(35.37453F));
		Q2MapDrive.withOutput(new Text("United States"), new FloatWritable(36.00504F));
		Q2MapDrive.withOutput(new Text("United States"), new FloatWritable(40.75F));
	...
	public void TestQ2ReducerExampleRow()
	{
		...
		Q2ReduceDrive.withInput(new Text("United States"), testList);
		
		Float output = (Math.abs(35.37453F - 36.00504F) + Math.abs(36.00504F - 40.75F))/2;
		
		Q2ReduceDrive.withOutput(new Text("United States"), new FloatWritable(output));
	...
	public void TestQ2MapReduceCombo()
	{
		...
		Q2mapReduceDriver.withOutput(new Text("United States"), new FloatWritable(output));
	...
	public void TestQ3ARGMapper()
	{
		...
		Q3MapDrive.withOutput(new Text("test AGR (2000-2015)"), new Text("y1: 0.95"));
		Q3MapDrive.withOutput(new Text("test AGR (2000-2015)"), new Text("y2: 0.93"));
	...
	public void TestQ3INDMapper()
	{
		...
		Q3MapDrive.withOutput(new Text("test IND (2000-2015)"), new Text("y1: 0.95"));
		Q3MapDrive.withOutput(new Text("test IND (2000-2015)"), new Text("y2: 0.93"));
	...
	public void TestQ3SRVMapper()
	{
		...
		Q3MapDrive.withOutput(new Text("test SRV (2000-2015)"), new Text("y1: 0.95"));
		Q3MapDrive.withOutput(new Text("test SRV (2000-2015)"), new Text("y2: 0.93"));
	...
	{
		List<Text> testList = new ArrayList<Text>();
		
		testList.add(new Text("y1: 0.95"));
		
		testList.add(new Text("y2: 0.93"));
		
		Q3ReduceDrive.withInput(new Text("test SRV (2000-2015)"), testList);
		
		Q3ReduceDrive.withOutput(new Text("test SRV (2000-2015)"), new FloatWritable(-2.105261F));
	...
	public void TestQ3MapperAndReducer()
	{
		...
		Q3mapReduceDriver.withOutput(new Text("test AGR (2000-2015)"), new FloatWritable(-2.105261F));
		
		Q3mapReduceDriver.withOutput(new Text("test IND (2000-2015)"), new FloatWritable(-2.105261F));
		
		Q3mapReduceDriver.withOutput(new Text("test SRV (2000-2015)"), new FloatWritable(-2.105261F));
	...
	public void TestQ4ARGMapper()
	{
		...
		Q4MapDrive.withOutput(new Text("test AGR (2000-2015)"), new Text("y1: 0.95"));
		Q4MapDrive.withOutput(new Text("test AGR (2000-2015)"), new Text("y2: 0.93"));
	...
	public void TestQ4INDMapper()
	{
		...
		Q4MapDrive.withOutput(new Text("test IND (2000-2015)"), new Text("y1: 0.95"));
		Q4MapDrive.withOutput(new Text("test IND (2000-2015)"), new Text("y2: 0.93"));
	...
	public void TestQ4SRVMapper()
	{
		...
		Q4MapDrive.withOutput(new Text("test SRV (2000-2015)"), new Text("y1: 0.95"));
		Q4MapDrive.withOutput(new Text("test SRV (2000-2015)"), new Text("y2: 0.93"));
	...
	public void TestQ4Reducer()
	{
		...
		Q4ReduceDrive.withInput(new Text("test SRV (2000-2015)"), testList);
		
		Q4ReduceDrive.withOutput(new Text("test SRV (2000-2015)"), new FloatWritable(-2.105261F));
	...
	public void TestQ4MapperAndReducer()
	{
		...
		Q4mapReduceDriver.withOutput(new Text("test AGR (2000-2015)"), new FloatWritable(-2.105261F));
		
		Q4mapReduceDriver.withOutput(new Text("test IND (2000-2015)"), new FloatWritable(-2.105261F));
		
		Q4mapReduceDriver.withOutput(new Text("test SRV (2000-2015)"), new FloatWritable(-2.105261F));
	...
	@Test
	public void TestQ4MapperAndReducer2()
	{
		Q4mapReduceDriver.withInput(new LongWritable(1),
				new Text("\"Algeria\",\"DZA\",\"Employment in services, male (% of male employment)\",\"SL.SRV.EMPL.MA.ZS\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"53.9300003051758\",\"\",\"53.4199981689453\",\"53.8400001525879\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"39.2299995422363\",\"28.2999992370605\",\"\",\"\","));
		Q4mapReduceDriver.withOutput(new Text("Algeria SRV (2001-2014)"), new FloatWritable((28.3F-53.93F)*100/(53.93F)));
	...
	public void TestQ5MapperExampleRow()
	{
		...
		Q5MapDrive.withOutput(new Text("United States"), new DoubleWritable(35.37453));
		Q5MapDrive.withOutput(new Text("United States"), new DoubleWritable(36.00504));
		Q5MapDrive.withOutput(new Text("United States"), new DoubleWritable(37.52263));
		Q5MapDrive.withOutput(new Text("United States"), new DoubleWritable(-1.0));
		Q5MapDrive.withOutput(new Text("United States"), new DoubleWritable(38.44067));
		Q5MapDrive.withOutput(new Text("United States"), new DoubleWritable(39.15297));
		Q5MapDrive.withOutput(new Text("United States"), new DoubleWritable(39.89922));
		Q5MapDrive.withOutput(new Text("United States"), new DoubleWritable(40.53132));
		Q5MapDrive.withOutput(new Text("United States"), new DoubleWritable(41.12231));
		Q5MapDrive.withOutput(new Text("United States"), new DoubleWritable(20.18248));
		Q5MapDrive.withOutput(new Text("United States"), new DoubleWritable(20.38445));
		Q5MapDrive.withOutput(new Text("United States"), new DoubleWritable(20.68499));
		Q5MapDrive.withOutput(new Text("United States"), new DoubleWritable(-1.0));
	...
	public void TestQ5ReducerExampleRow()
	{
		...
		Q5ReduceDrive.withInput(new Text("United States"), testList);
		
		Double output = (41.12231 - 20.18248);
		
		Q5ReduceDrive.withOutput(new Text("United States (2011-2012)"), new DoubleWritable(output));
	...
	public void TestQ5MapReduceCombo()
	{
		...
		Q5mapReduceDriver.withOutput(new Text("United States (2011-2012)"), new DoubleWritable(output));
